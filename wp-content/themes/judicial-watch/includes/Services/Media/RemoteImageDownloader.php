 ...
 *
 * Source: https://kellenmace.com/download-insert-remote-image-file-wordpress-media-library/
 * Accessed: 2018-10-23
 *
 * Usage:
...
class RemoteImageDownloader {
	 ...
	 * }
	 */
	public function __construct($url, $attachment_data = []) {
	...
	private function is_supported_image_type($mime_type) {
		return in_array($mime_type, ['image/jpeg', 'image/gif', 'image/png', 'image/x-icon'], true);
	}
